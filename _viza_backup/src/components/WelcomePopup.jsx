...
export default function WelcomePopup({ message, onClose }) {
  return (
    <div style={styles.overlay}>
      <div style={styles.popup}>
        <button aria-label="Close welcome popup" onClick={onClose} style={styles.closeBtn}>
          &times;
        </button>

        <h1 style={styles.welcomeText}>Welcome to the</h1>
